      ...
      <div className='flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5'>
        ...
        <div className='flex-1'>
          ...
          <p className='text-sm mt-5'>
            Sign up with your email and password and explore
          </p>
        </div>
        {/* right */}

        <div className='flex-1'>
          <form className='flex flex-col mx-5 gap-4' onSubmit={handleSubmit}>
            <div>
            ...
            <Button
              className='bg-gradient-to-l from-pink-800 via-gray-700 to-black'
              type='submit'
              disabled={loading}
            >
              {loading ? (
